                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form accept-charset="utf-8">
                                    <div class="row g-2">
                                        <div class="col">
                                            <label for="name" class="form-label sr-only">Adv info</label>
                                            <input name="name" type="text" placeholder="Jane Doe" class="form-control">
                                        </div>
                                        <div class="col">
                                            <label for="username" class="form-label sr-only">Doc type</label>
                                            <input type="text" name="username" placeholder="Username" class="form-control">
                                        </div>
                                        <div class="col">
                                            <label for="username" class="form-label sr-only">Doc Number</label>
                                            <input type="text" name="username" placeholder="Username" class="form-control">
                                        </div>
                                        <div class="col">
                                            <label for="username" class="form-label sr-only">Number of PAC</label>
                                            <input type="text" name="username" placeholder="Username" class="form-control">
                                        </div>
                                        <div class="col">
